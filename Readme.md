...
<div align="center">
<img src="./frontend/public/system-design.svg" alt="SystemDesign" />
</div>
...
| [backend_deployment.yaml](https://github.com/jatolentino/NextJS-Flask/blob/master/k8s/backend_deployment.yaml)   | Code Summary:👩‍💻 Tech Lead implemented backend services using Flask for API routing within the Next.js platform. Enhances server-side functionality and data retrieval in the parent repository.                                                     |
...
| [layout.tsx](https://github.com/jatolentino/NextJS-Flask/blob/master/frontend/app/layout.tsx)   | Code snippet: ✔️👨‍💻Summary: Flask backend API routes handle data processing for NextJS frontend, ensuring seamless interactions and efficient data flow within the repository architecture.                     |
